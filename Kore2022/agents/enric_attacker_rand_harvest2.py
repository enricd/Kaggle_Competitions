...
def shipyard_is_targeted(shipyard, board):
    pass
...
def agent(obs, config):
    ...
    for shipyard in me.shipyards:
        ...
        if turn % 50 < 20 and shipyard.ship_count >= 50:
        ...
        elif (turn % 3 == 0) and shipyard.ship_count > (8 + int(turn/5)) or (not me.fleets and shipyard.ship_count > 10):
